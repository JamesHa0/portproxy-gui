...
- 版本：本地 tag v1.0.0 已规划，Release 由用户手动发布；推送由用户手动完成。
...
- ✅ P1 防火墙联动（已做）
- ✅ P1 规则编辑（已做）
- ⬜ P2 开机自启持久化：竞品通过注册表 Run 键 / Windows 服务实现；netsh 规则本身已持久，可加"开机自启本程序"开关。
- ⬜ P2 系统托盘：最小化到托盘 + 托盘菜单（竞品标配，体验提升明显）。
